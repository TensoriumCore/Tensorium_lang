...
RUNNER_SRC="$ROOT_DIR/tools/dev/runtime_generated_spectral_bowen_york_puncture.cpp"
...
LL_PATH="/tmp/tensorium_generated_spectral_bowen_york_puncture.ll"
OBJ_PATH="/tmp/tensorium_generated_spectral_bowen_york_puncture.o"
HOST_HEADER="/tmp/tensorium_generated_spectral_bowen_york_puncture_host.h"
EXE_PATH="/tmp/tensorium_generated_spectral_bowen_york_puncture_runner"
...
echo "[generated-spectral-bowen-york-puncture] generating LLVM IR and host header"
"$DRIVER" \
...
echo "[generated-spectral-bowen-york-puncture] compiling LLVM object"
...
echo "[generated-spectral-bowen-york-puncture] compiling runtime runner"
"$CXX_BIN" -O0 -std=c++20 -I "$ROOT_DIR/include" -include "$HOST_HEADER" \
  "$RUNNER_SRC" "$OBJ_PATH" -lm -o "$EXE_PATH"

echo "[generated-spectral-bowen-york-puncture] running runtime executable"
"$EXE_PATH"
