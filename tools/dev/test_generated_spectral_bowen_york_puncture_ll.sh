...
tensorium_generated_spectral_smoke \
  "generated-spectral-bowen-york-puncture" \
  "$ROOT_DIR/tests/fixtures/elliptic/spectral_bowen_york_regularized_puncture_3d.tn" \
  "$ROOT_DIR/tools/dev/runtime_generated_spectral_bowen_york_puncture.cpp" \
  "tensorium_generated_spectral_bowen_york_puncture" \
