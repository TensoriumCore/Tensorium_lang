...
RUNNER_SRC="$ROOT_DIR/tools/dev/runtime_generated_spectral_aux_residual.cpp"
...
LL_PATH="/tmp/tensorium_generated_spectral_aux_residual.ll"
OBJ_PATH="/tmp/tensorium_generated_spectral_aux_residual.o"
HOST_HEADER="/tmp/tensorium_generated_spectral_aux_residual_host.h"
EXE_PATH="/tmp/tensorium_generated_spectral_aux_residual_runner"
...
echo "[generated-spectral-aux-residual] generating LLVM IR and host header"
"$DRIVER" \
...
echo "[generated-spectral-aux-residual] compiling LLVM object"
...
echo "[generated-spectral-aux-residual] compiling runtime runner"
"$CXX_BIN" -O0 -std=c++20 -I "$ROOT_DIR/include" -include "$HOST_HEADER" \
  "$RUNNER_SRC" "$OBJ_PATH" -lm -o "$EXE_PATH"

echo "[generated-spectral-aux-residual] running runtime executable"
"$EXE_PATH"
