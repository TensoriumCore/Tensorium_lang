...
LL_PATH="/tmp/tensorium_bowen_york_single_puncture_relax_l2.ll"
OBJ_PATH="/tmp/tensorium_bowen_york_single_puncture_relax_l2.o"
EXE_PATH="/tmp/tensorium_bowen_york_single_puncture_relax_l2_runner"
HOST_HEADER="/tmp/tensorium_bowen_york_single_puncture_relax_l2_host.h"
...
echo "[bowen-york-single-puncture-l2] generating LLVM IR and host header: $LL_PATH"
"$DRIVER" \
...
echo "[bowen-york-single-puncture-l2] compiling LLVM object"
...
echo "[bowen-york-single-puncture-l2] compiling runtime L2 runner"
...
echo "[bowen-york-single-puncture-l2] running runtime L2 executable"
"$EXE_PATH"
