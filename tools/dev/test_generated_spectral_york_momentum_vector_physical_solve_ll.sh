...
tensorium_generated_spectral_smoke \
  "generated-spectral-york-vector-physical" \
  "$ROOT_DIR/tests/fixtures/elliptic/spectral_york_momentum_vector_constraint_3d.tn" \
  "$ROOT_DIR/tools/dev/runtime_generated_spectral_york_momentum_vector_physical_solve.cpp" \
  "tensorium_generated_spectral_york_momentum_vector_physical_solve" \
