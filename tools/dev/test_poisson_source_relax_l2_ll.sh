...
RUNNER_SRC="$ROOT_DIR/tools/dev/runtime_poisson_source_relax_l2.cpp"
FIXTURE="$ROOT_DIR/tests/fixtures/elliptic/poisson_source_relax_3d.tn"
...
LL_PATH="/tmp/tensorium_poisson_source_relax_l2.ll"
OBJ_PATH="/tmp/tensorium_poisson_source_relax_l2.o"
EXE_PATH="/tmp/tensorium_poisson_source_relax_l2_runner"
HOST_HEADER="/tmp/tensorium_poisson_source_relax_l2_host.h"
...
echo "[poisson-source-relax-l2] generating LLVM IR and host header: $LL_PATH"
"$DRIVER" \
...
echo "[poisson-source-relax-l2] compiling LLVM object"
...
echo "[poisson-source-relax-l2] compiling runtime L2 runner"
...
echo "[poisson-source-relax-l2] running runtime L2 executable"
"$EXE_PATH"
